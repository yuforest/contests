...
// A,Bを正の整数とし、それらの最大公約数をgとおく
// A = g * a, B = g * bとおくと、a個の数0, BmodA, 2BmodA, ..., (a-1)BmodA
// の中には0, g, 2g, ..., (a-1)gの(すなわち0以上A未満のgの倍数)がちょうど1回ずつ含まれる
int main() {
  int t;
  cin >> t;
  while (t--) {
    ...
    cin >> n >> d >> k;
    --k;
    // nの中にnとdの最大公約数の倍数が何個あるか
    // これで最大公約数の倍数を1周するのに何回かかるかがわかる
    int a = n / gcd(n, d);
    debug(a);
    // 何回1周したのか+移動距離をnであまりをとったもの
